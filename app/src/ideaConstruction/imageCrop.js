      ...
      template:   '<div id="image-crop-{{ rand }}" class="ng-image-crop ng-image-crop--{{ shape }}" ng-style="moduleStyles">'+
                      '<section ng-style="sectionStyles" ng-show="step==1">'+
                          '<div class="fileUpload btn btn-default">'+
                              ...
                              '<input type="file" class="upload image-crop-input" >'+
                          '</div>'+
                      '</section>'+

                      '<section ng-style="sectionStyles" ng-show="step==2">'+
                          '<canvas class="cropping-canvas" width="{{ canvasWidth }}" height="{{ canvasHeight }}" ng-mousemove=" '+ 
                          'onCanvasMouseMove($event)" ng-mousedown="onCanvasMouseDown($event)" ng-mouseup="onCanvasMouseUp($event)"> '+
                          '</canvas>'+
                          ...
                          '<div class="zoom-handle" ng-mousemove="onHandleMouseMove($event)" ng-mousedown="onHandleMouseDown($event)" '+            
                              'ng-mouseup="onHandleMouseUp($event)">'+
